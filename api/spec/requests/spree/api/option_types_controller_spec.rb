...
module Spree
  describe Api::OptionTypesController, type: :request do
    ...
    it "can list all option types" do
      get spree.api_option_types_path, headers: user.create_new_auth_token
    ...
    it "can search for an option type" do
      ...
      get spree.api_option_types_path, headers: user.create_new_auth_token, params: { q: { name_cont: option_type.name } }
      expect(json_response.count).to eq(1)
      expect(json_response.first).to have_attributes(attributes)
    end
    ...
    it "can retrieve a list of specific option types" do
      ...
      create(:option_type)
      get spree.api_option_types_path, headers: user.create_new_auth_token, params: { ids: "#{option_type.id},#{option_type_1.id}" }
    ...
    it "can list a single option type" do
      get spree.api_option_type_path(option_type), headers: user.create_new_auth_token
      expect(json_response).to have_attributes(attributes)
      check_option_values(json_response["option_values"])
    end

    it "cannot create a new option type" do
      post spree.api_option_types_path, headers: user.create_new_auth_token, params: {
        option_type: {
          name: "Option Type",
    ...
    it "cannot alter an option type" do
      ...
      put spree.api_option_type_path(option_type), headers: user.create_new_auth_token, params: {
        option_type: {
          name: "Option Type"
        }
      }
    ...
    it "cannot delete an option type" do
      delete spree.api_option_type_path(option_type), headers: user.create_new_auth_token
      assert_not_found!
    ...
    context "as an admin" do
      it "can create an option type" do
        post spree.api_option_types_path, headers: admin_user.create_new_auth_token, params: {
          option_type: {
            name: "Option Type",
            presentation: "Option Type"
          }
      ...
      it "cannot create an option type with invalid attributes" do
        post spree.api_option_types_path, headers: admin_user.create_new_auth_token, params: { option_type: {} }
        expect(response.status).to eq(422)
      end

      it "can update an option type" do
        put spree.api_option_type_path(option_type.id), headers: admin_user.create_new_auth_token, params: { option_type: { name: "Option Type" } }
      ...
      it "cannot update an option type with invalid attributes" do
        put spree.api_option_type_path(option_type.id), headers: admin_user.create_new_auth_token, params: { option_type: { name: "" } }
        expect(response.status).to eq(422)
      end

      it "can delete an option type" do
        delete spree.api_option_type_path(option_type.id), headers: admin_user.create_new_auth_token
